...
const rentalInwardRoutes = require('./routes/rentalInwardRoutes');
const rentalProductRoutes = require('./routes/rentalProductRoutes');
const rentalSupplierRoutes = require('./routes/rentalSupplierRoutes');
const rentalCustomerRoutes = require('./routes/rentalCustomerRoutes');
const rentalCategoryRoutes = require('./routes/rentalCategoryRoutes');
const productItemRoutes = require('./routes/productItemRoutes');
const rentalInventoryItemRoutes = require('./routes/rentalInventoryItemRoutes');
...
app.use('/api/rental-inwards', rentalInwardRoutes);
app.use('/api/rental-products', rentalProductRoutes);
app.use('/api/rental-suppliers', rentalSupplierRoutes);
app.use('/api/rental-customers', rentalCustomerRoutes);
app.use('/api/rental-categories', rentalCategoryRoutes);
app.use('/api/product-items', productItemRoutes);
app.use('/api/rental-inventory-items', rentalInventoryItemRoutes);
